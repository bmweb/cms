...
class Course extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('name, code, course_level_id', 'required'),
			array('duration, is_active, course_level_id, course_field_id', 'numerical', 'integerOnly'=>true),
			array('name', 'length', 'max'=>100),
			array('code, duration_type', 'length', 'max'=>20),
